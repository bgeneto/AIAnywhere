...
{    public partial class ConfigWindow : Window
    {
        ...
        }        private void LoadConfiguration()
        {
            ...
            {
                ApiKeyPasswordBox.Password = PortableEncryptionService.MaskSensitiveTextFully(_config.ApiKey); // Show all dots
            }
            else
            {
            ...
            try
            {
                ...
                if (pasteBehaviorIndex >= 0 && pasteBehaviorIndex < PasteBehaviorComboBox.Items.Count)
                {
        ...
        }        private void UpdatePasteBehaviorDescription()
        {
            try
            {
                ...
                {
                    case 0: // AutoPaste
                        PasteBehaviorDescriptionTextBlock.Text = "Auto-paste provides the smoothest workflow but requires trust in AI results. Press Ctrl+Z to undo if needed.";
                        break;
                    case 1: // ClipboardMode
                        PasteBehaviorDescriptionTextBlock.Text = "Copy to clipboard mode gives you full control. You manually paste (Ctrl+V) where you want the result.";
                        break;
                    case 2: // ReviewMode
                        PasteBehaviorDescriptionTextBlock.Text = "Review mode shows a beautiful preview window where you can review and confirm before pasting.";
                        break;
                    default:
                        PasteBehaviorDescriptionTextBlock.Text = "Choose how AI results are handled after processing.";
                        break;
                }
            }
            catch { }
        ...
        private void PasteBehaviorComboBox_SelectionChanged(object sender, System.Windows.Controls.SelectionChangedEventArgs e)
        {
            try
            {
                UpdatePasteBehaviorDescription();
        ...
        }        private void SaveButton_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                MessageBox.Show("Configuration saved successfully!\n\nRestart the application for hotkey changes to take effect.", "Success", 
        ...
        }        private async void RetrieveModelsButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (string.IsNullOrWhiteSpace(actualApiKey))
            {
                ...
                ModelStatusTextBlock.Foreground = new System.Windows.Media.SolidColorBrush(System.Windows.Media.Colors.Red);
            ...
            try
            {
                ...
                ModelStatusTextBlock.Foreground = new System.Windows.Media.SolidColorBrush(System.Windows.Media.Colors.Blue);
                ModelStatusTextBlock.Visibility = Visibility.Visible;
                ...
                if (models.Any())                {
                    ...
                    ModelStatusTextBlock.Foreground = new System.Windows.Media.SolidColorBrush(System.Windows.Media.Colors.Green);
                }
                else
                {
                    ModelStatusTextBlock.Text = "No models found or API returned empty list";
                    ModelStatusTextBlock.Foreground = new System.Windows.Media.SolidColorBrush(System.Windows.Media.Colors.Orange);
                }
            }
            catch (System.Exception ex)
            {
        ...
        private string _originalHotkeyValue = "";        private void HotkeyTextBox_GotFocus(object sender, RoutedEventArgs e)
        {
            _isCapturingHotkey = true;
            _originalHotkeyValue = HotkeyTextBox.Text;
            HotkeyTextBox.Text = "Press your desired key combination...";
            HotkeyTextBox.Background = new System.Windows.Media.SolidColorBrush(System.Windows.Media.Color.FromRgb(255, 255, 224)); // Light yellow
        ...
        }private void HotkeyTextBox_PreviewKeyDown(object sender, KeyEventArgs e)
        {
            ...
            if (e.Key == Key.LeftCtrl || e.Key == Key.RightCtrl ||
                ...
                e.Key == Key.System) // Alt key variations
            {
                return;
            }

            // Require at least one modifier key for hotkeys (except function keys)
            bool hasModifier = (Keyboard.Modifiers & (ModifierKeys.Control | ModifierKeys.Alt | ModifierKeys.Shift | ModifierKeys.Windows)) != 0;
        ...
        }        private string GetActualApiKey()
        {
            ...
            System.Diagnostics.Debug.WriteLine($"GetActualApiKey: _isApiKeyModified={_isApiKeyModified}");
            System.Diagnostics.Debug.WriteLine($"GetActualApiKey: ApiKeyPasswordBox.Password='{ApiKeyPasswordBox.Password}' (length={ApiKeyPasswordBox.Password?.Length ?? 0})");
            System.Diagnostics.Debug.WriteLine($"GetActualApiKey: _config.ApiKey='{_config.ApiKey}' (length={_config.ApiKey?.Length ?? 0})");
            ...
            if (_isApiKeyModified)
            {
                ...
                if (string.IsNullOrEmpty(ApiKeyPasswordBox.Password))
                {
                    ...
                    result = "";
                    System.Diagnostics.Debug.WriteLine("GetActualApiKey: User cleared the field -> empty string");
                }
                else if (ApiKeyPasswordBox.Password.All(c => c == '•'))
                {
                    ...
                    System.Diagnostics.Debug.WriteLine("GetActualApiKey: Masked key unchanged -> using config key");
                }
                else
                {
            ...
            else
            {
                ...
                result = _config.ApiKey ?? "";
                System.Diagnostics.Debug.WriteLine("GetActualApiKey: Field not modified -> using config key");
            }
