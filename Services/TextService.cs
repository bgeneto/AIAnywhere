...
namespace AIAnywhere.Services
{
    public class TextService
    {
        ...
        public static string GetSelectedText()
        {
            try
            {
                System.Diagnostics.Debug.WriteLine(
                    "DEBUG: GetSelectedText() called - trying UI Automation first"
                );
                ...
                System.Diagnostics.Debug.WriteLine(
                    "DEBUG: UI Automation found no selection, trying keyboard simulation fallback"
                );
                ...
                {
                    System.Diagnostics.Debug.WriteLine(
                        $"DEBUG: ✓ Keyboard simulation succeeded: '{keyboardText}'"
                    );
                    return keyboardText;
                }
            ...
            {
                System.Diagnostics.Debug.WriteLine(
                    $"DEBUG: GetSelectedText() exception: {ex.Message}"
                );
                return "";
            }
        }
        ...
        private static string GetSelectedTextViaKeyboardSimulation()
        {
            ...
            {
                System.Diagnostics.Debug.WriteLine(
                    "DEBUG: GetSelectedTextViaKeyboardSimulation() called"
                );

                // Get the currently focused window first
                var currentWindow = GetForegroundWindow();
                System.Diagnostics.Debug.WriteLine(
                    $"DEBUG: Current foreground window: {currentWindow}"
                );
                ...
                try
                {
                    if (Clipboard.ContainsText())
                    {
                        ...
                        System.Diagnostics.Debug.WriteLine(
                            $"DEBUG: Original clipboard content: '{originalClipboard}'"
                        );
                    }
                    else if (Clipboard.ContainsImage())
                    {
                        ...
                        System.Diagnostics.Debug.WriteLine(
                            "DEBUG: Original clipboard contains image"
                        );
                    }
                }
                catch (Exception ex)
                {
                    System.Diagnostics.Debug.WriteLine(
                        $"DEBUG: Error reading original clipboard: {ex.Message}"
                    );
                }
                ...
                {
                    System.Diagnostics.Debug.WriteLine(
                        $"DEBUG: Error clearing clipboard: {ex.Message}"
                    );
                }
                ...
                try
                {
                    if (Clipboard.ContainsText())
                    {
                        ...
                        System.Diagnostics.Debug.WriteLine(
                            $"DEBUG: Retrieved selected text: '{selectedText}'"
                        );
                        ...
                        {
                            System.Diagnostics.Debug.WriteLine(
                                "DEBUG: Selected text is same as original clipboard - likely no text was selected"
                            );
                    ...
                    {
                        System.Diagnostics.Debug.WriteLine(
                            "DEBUG: No text found in clipboard after Ctrl+C"
                        );
                    }
                }
                catch (Exception ex)
                {
                    System.Diagnostics.Debug.WriteLine(
                        $"DEBUG: Error reading clipboard after Ctrl+C: {ex.Message}"
                    );
                }
                ...
                try
                {
                    ...
                    )
                    {
                        ...
                        System.Diagnostics.Debug.WriteLine(
                            "DEBUG: Restored original clipboard text content"
                        );
                    }
                    else if (originalClipboardFormat == "image")
                    {
                        ...
                        Clipboard.Clear();
                        System.Diagnostics.Debug.WriteLine(
                            "DEBUG: Cleared clipboard (had image content)"
                        );
                    }
                    else
                    {
                        Clipboard.Clear();
                        System.Diagnostics.Debug.WriteLine(
                            "DEBUG: Cleared clipboard (no original content)"
                        );
                    }
                }
                catch (Exception ex)
                {
                    System.Diagnostics.Debug.WriteLine(
                        $"DEBUG: Error restoring clipboard: {ex.Message}"
                    );
                }

                System.Diagnostics.Debug.WriteLine(
                    $"DEBUG: GetSelectedTextViaKeyboardSimulation() returning: '{selectedText}'"
                );
                return selectedText;
            }
            catch (Exception ex)
            {
                System.Diagnostics.Debug.WriteLine(
                    $"DEBUG: GetSelectedTextViaKeyboardSimulation() exception: {ex.Message}"
                );
                return "";
            }
        }
        ...
        public static string GetClipboardText()
        {
            try
            {
                ...
                if (Clipboard.ContainsText())
                {
                    ...
                    System.Diagnostics.Debug.WriteLine(
                        $"DEBUG: GetClipboardText() returning: '{clipboardText}'"
                    );
                    return clipboardText;
                }
                System.Diagnostics.Debug.WriteLine(
                    "DEBUG: GetClipboardText() - clipboard contains no text"
                );
                return "";
            }
            catch (Exception ex)
            {
                System.Diagnostics.Debug.WriteLine(
                    $"DEBUG: GetClipboardText() exception: {ex.Message}"
                );
                return "";
            }
        }
